...
def get_addtional_info_hdd(driver, url):
    ...
    try:
        ...
        key_map = {
            ...
            "회전수": "rpm",
            "버퍼 용량": "buffer_size",
            "전송 속도": "transfer_speed",
            "기록방식": "recording_method",
            "디스크 수": "disk_count",
            "두께": "thickness",
            "작업부하량": "workload",
            "소음(유휴/탐색)": "noise_level",
            "A/S 정보": "warranty_period",
            "헬륨충전": "helium_filled",
            "RV센서": "rv_sensor",
            "사용보증": "warranty_usage",
            "데이터 복구 3년": "data_recovery_3y",
            "데이터 복구 2년": "data_recovery_2y",
            "데이터 복구 1년": "data_recovery_1y",
            "가로": "width",
            "세로": "height",
            "전원": "power",
            "무게": "weight",
...
def crawl_danawa_hdd():
    ...
    while True:
       ...
       # ✅ 각 페이지 첫 번째 상품
        ...
        try:
            ...
            options = get_addtional_info_hdd(driver, link) or {}
    ...
    driver.quit()
    save_to_json(results, "hdd_danawa_test.json")
    return results



def save_to_json(results, filename="hdd_danawa_test.json"):
