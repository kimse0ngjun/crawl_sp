...
def get_addtional_info_sdd(driver, url):
    ...
    try:
        ...
        key_map = {
            ...
            "용량": "capacity",
            "메모리 타입": "memory_type",
            "낸드 구조": "nand_structure",
            "RAM 탑재": "ram_installed",
            "RAM 타입": "ram_type",
            "컨트롤러": "controller",
            "순차읽기": "seq_read",
            "순차쓰기": "seq_write",
            ...
            "S.M.A.R.T": "smart",
            "ECC": "ecc",
            "전용 S/W": "software_tool",
            "마이그레이션": "migration",
            "관리기능": "management_tool",
            "MTBF": "mtbf",
            "TBW": "tbw",
            "게임기 호환": "console_compatibility",
            "A/S기간": "warranty_period",
            "제한보증": "limited_warranty",
            "NVMe 방열판": "nvme_heatsink",
            "가로": "width",
            "세로": "height",
            "두께": "thickness",
            "무게": "weight",
            "AES 암호화": "aes_encryption",
            "5년": "as_5",
            "4년": "as_4",
            "3년": "as_3",
            "2년": "as_2",
        ...
        skip_sections = ["등록년월", "적합성평가인증", "안전확인인증"]
...
def crawl_danawa_hdd():
    ...
    while True:
       ...
       # 각 페이지 첫 번째 상품
        ...
        try:
            ...
            options = get_addtional_info_sdd(driver, link) or {}
    ...
    driver.quit()
    save_to_json(results, "sdd_danawa_test.json")
    return results



def save_to_json(results, filename="sdd_danawa_test.json"):
    with open(filename, "w", encoding="utf-8") as f:
        json.dump(results, f, ensure_ascii=False, indent=4)


if __name__ == "__main__":
    results = crawl_danawa_hdd()
    save_to_json(results, "sdd_danawa_test.json")
    print("JSON 저장 완료")
